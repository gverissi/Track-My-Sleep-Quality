...
package com.gregcorp.trackmysleepquality.sleepdetail
...
import com.gregcorp.trackmysleepquality.databinding.FragmentSleepDetailBinding
...
class SleepDetailFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        // Add an Observer to the state variable for Navigating when the close button is tapped.
