...
class SleepNightAdapter : RecyclerView.Adapter<SleepNightAdapter.ViewHolder>() {
    ...
    /**
     * Part of the RecyclerView adapter, called when RecyclerView needs to know the size of the list
     */
     ...
     *
     * A ViewHolder holds a view for thr [RecyclerView] as well as providing additional informations
